...
CLASS="uk.ac.imperial.lsds.crossbow.LeNet"
CLASSFILE="${TESTS}/`echo ${CLASS} | tr '.' '/'`.class"

resultdir="$CROSSBOW_HOME/scripts/benchmarks/results/"
...
resultfile="lenet.out"
	
datadirectory=`printf "$CROSSBOW_HOME/data/mnist/b-%03d" $batchsize`
