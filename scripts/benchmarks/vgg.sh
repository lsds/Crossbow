...
CLASS="uk.ac.imperial.lsds.crossbow.VGG"
CLASSFILE="${TESTS}/`echo ${CLASS} | tr '.' '/'`.class"

resultdir="results/no-local-update"
...
learningrategamma="0.5" # For VGG, divide rate by 2
decay="0.0005"
...
# Configure learning rate steps
learningratesteps="20,40,60,80,100,120,140,160,180,200,220,240"
...
datadirectory=`printf "$CROSSBOW_HOME/data/cifar-100/b-%03d" $batchsize`
