...
CLASS="uk.ac.imperial.lsds.crossbow.preprocess.mnist.MNIST"
...
inputdirectory="$CROSSBOW_HOME/data/mnist/original"
outputdirectory=`printf "$CROSSBOW_HOME/data/mnist/b-%03d" $batchsize`
