...
void crossbowRecordReaderRead (crossbowRecordReaderP, unsigned, int, int, void *, int);

void crossbowRecordReaderReadProperly (crossbowRecordReaderP, unsigned, int, int *, int, int *, void *, void *, int *);
